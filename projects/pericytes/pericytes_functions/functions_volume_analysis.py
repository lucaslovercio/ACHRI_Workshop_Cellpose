...
def plot_save_volume_histogram(df, filename, bins=5):
    
    plt.figure(figsize=(8, 5))
    plt.hist(df["Volume"], bins=bins, edgecolor="black", alpha=0.7)
...
def plot_save_sphericity_histogram(df, filename, bins=5):
    
    plt.figure(figsize=(8, 5))
    plt.hist(df["Sphericity"], bins=bins, range=(0, 1), edgecolor="black", alpha=0.7)
...
def plot_save_length_histogram(df, filename, bins=5):
    
    plt.figure(figsize=(8, 5))
    plt.hist(df["Length"], bins=bins, edgecolor="black", alpha=0.7)
